...
export const salesRecordsDemo = [
    ...
    },
    {
        ...
        "count": 2,
        "set_rate": 1.5,
        "average_spend": 18333.333333333332,
        "date": "2024-01-03"
    },
    {
        "total_amount": 30000,
    ...
    },
    {
        ...
        "count": 5,
        "set_rate": 1.4,
        "average_spend": 14714.285714285714,
        "date": "2024-03-03"
    },
    {
        "total_amount": 62000,
        ...
        "count": 2,
        "set_rate": 1.5,
        "average_spend": 20666.666666666668,
        "date": "2024-03-04"
    },
    {
        "total_amount": 66000,
    ...
    },
    {
        ...
        "count": 3,
        "set_rate": 2,
        "average_spend": 18166.666666666668,
        "date": "2024-03-09"
    },
    {
        "total_amount": 50000,
...
export const monthlyReportsDemo = [
    {
        "id": -100,
        "content": "今月は、会員優待のDM連絡を通じた来店者数の増加と、既存VIP会員のランクキープ・1名のランクアップを達成しました。これにより顧客様売上が店舗全体でトップとなり、店舗予算への貢献が実現しました。また、オンライン上での商品閲覧についても顧客の来店要因として重要であることが伺えました。 \n\nライト層のビジターやファッション好きな30〜40代のお客様に対して、店内でのアウターの提案を意識的に行いました。特に、アウターとの組み合わせを店頭で強調し試着を促進、また商品のメリットをスムーズに伝えることで成約率を高めることができました。\n\n一方で時間の制約等から商品への説得力が不足しており、さらに商品の魅力を伝達するアピール力が必要と感じるとともに、気温の影響を受けずに商品を買い上げてもらえる工夫も求められる月でした。",
        "month": "2024-03"
    }
];
