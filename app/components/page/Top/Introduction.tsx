...
import { ChatBubbleLeftEllipsisIcon, ChevronDoubleDownIcon, HandThumbUpIcon, LightBulbIcon, PencilIcon, SparklesIcon } from '@heroicons/react/24/outline';
    ...
    <>
      <section className="text-gray-600 body-font max-w-xs md:max-w-2xl lg:max-w-4xl bg-white rounded-sm shadow-md">
        <Carousel withIndicators controlsOffset="xs" loop className='flex w-full pb-3'>
          <Carousel.Slide>
            <div className="container mx-auto flex px-5 py-3 md:flex-row flex-col items-center bg-white">
              ...
              <div className="lg:flex-grow md:w-1/2 lg:pl-10 md:pl-5 flex flex-col md:items-start md:text-left items-center text-center bg-white">
                ...
                <p className="text-md md:text-xl text-lg font-bold mb-1 md:mb-3">sales buddy へようこそ。</p>
          ...
          <Carousel.Slide>
            <div className="container mx-auto flex px-5 pt-7 md:flex-row flex-col items-center bg-white">
              ...
              <div className="lg:flex-grow md:w-1/2 lg:pl-10 md:pl-5 flex flex-col md:items-start md:text-left items-center text-center bg-white">
                <h1 className="title-font text-3xl md:text-4xl font-medium text-gray-500 mb-4 font-bold">何ができるの？</h1>
                <p className="text-md md:text-lg border-b font-bold mt-2">日々の個人売上を管理します</p>
                <div className='flex flex-row items-center'>
                  <p className="text-sm md:text-md">セット率や客単価もお任せあれ</p>
                  <HandThumbUpIcon className='h-5 w-5 text-md text-gray-500 ml-1'/>
                </div>
                <p className="text-md md:text-lg mt-4 border-b font-bold">週ごとに目標達成をサポート</p>
                ...
                <p className="text-md md:text-lg mt-4 border-b font-bold">振り返りをしやすく</p>
                <div className='flex flex-row items-center'>
                  <p className="text-sm md:text-md">週末に振り返りをしよう</p>
                  <PencilIcon className='h-5 w-5 text-md text-gray-500 ml-1'/>
                </div>
                <p className="text-sm md:text-md">月のまとめはAIが自動作成します。</p>
              </div>
            </div>
          </Carousel.Slide>
          <Carousel.Slide>
            <div className="container mx-auto flex px-5 pt-7 pb-5 md:flex-row flex-col items-center bg-white">
              ...
              <div className="lg:flex-grow md:w-1/2 lg:pl-10 md:pl-5 flex flex-col md:items-start md:text-left items-center text-center bg-white">
              <h1 className="title-font text-3xl md:text-4xl font-medium text-gray-500 mb-4 font-bold">知るきっかけに</h1>
                <p className="text-sm md:text-md mt-2">どの客層が得意なんだろう？</p>
                <p className="text-sm md:text-md mt-4">立てた目標に対して</p>
                <p className="text-sm md:text-md">どうやって取り組んだんだろう？</p>
                <p className="text-sm md:text-md mt-4">何の業務に時間使ったっけ？</p>
                <ChatBubbleLeftEllipsisIcon className='w-8 h-8 text-gray-500 my-4' />
                <p className="text-sm md:text-md">目標の立てっぱなし、</p>
                <p className="text-sm md:text-md">やりっぱなしにしないことで</p>
                <div className='flex flex-row items-center'>
                  <p className="text-sm md:text-lg font-bold">自分を知るきっかけにもなるはず</p>
