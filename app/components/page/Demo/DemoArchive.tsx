...
export default function DemoArchive() {
  ...
  return (
    ...
    <Modal opened={opened} onClose={close} title={modalTitle()} centered >
      <AchievementsDetail
        target={targetDemo}
        amount={thisWeekAmountDemo}
        number={thisWeekNumberDemo}
        count={thisWeekCountDemo}
        set={thisWeekSetDemo}
        average={thisWeekAverageDemo}
